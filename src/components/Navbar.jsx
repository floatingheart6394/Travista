...
export default function Navbar() {
  ...
  return (
    <nav className="navbar">
      <h2 data-cursor-big="true" onClick={() => navigate('/')} style={{ userSelect: 'none' }}>TRAVISTA</h2>
      <div className="nav-links">
        <a href="#explore" data-cursor-big="true">Explore</a>
        <a href="#plan" data-cursor-big="true">Plan</a>
